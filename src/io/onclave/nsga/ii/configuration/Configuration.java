...
public class Configuration {
    ...
    private static  int POPULATION_SIZE = 800;
    private static  int GENERATIONS = 800;
    private static  int CHROMOSOME_LENGTH = 114;
    private static  float CROSSOVER_PROBABILITY = 0.7f;
    private static  float MUTATION_PROBABILITY = 0.03f;
     ...
     */
  public static void buildObjectives(String fileLocation, int population, int generation, int chromosome, float crossover_p, float mutation_p, String readLocation) {
